...
echo    '<lastModifiedDate>'.date('d/m/Y h:i:s a', time()).'</lastModifiedDate>';
die;
foreach($_products as $product) {
	...
	$prijmessage=" (per ".$product['prijsfactor']." ".$prod->getData('verkoopeenheid').")";
    }
    ...
    */
    ...
    echo '
					<product>
						...
						<image>' . $this->getUrlBasePath() . '/media/catalog/product' . $product['image'] . '</image>
