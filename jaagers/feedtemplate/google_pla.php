...
echo '"id";"title";"short_description";"description";"sku";"link";"image_link";"google product category";"product type";"condition";"availability";"price";"prijsfactorprijs";"prijsfactor";"porto";"brand";"mpn";"ean", ' . chr(10) . chr(13);
...
foreach($_products as $product) {
	...
	*/
	...
	$shortDescription = html_entity_decode($product['short_description']);
