...
foreach($_products as $product) {
	...
	//$url = $this->getUrlBasePath() . '/' . $product['urlpath'] .'?utm_source=vergelijkers&amp;utm_medium=cpc&amp;utm_campaign=twenga.nl';
	...
	*/
	...
	echo '
					<product>
						...
						<designation><![CDATA[' . $product['name'] . $prijmessage . ']]></designation>
