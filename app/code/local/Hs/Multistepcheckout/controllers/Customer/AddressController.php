...
class Hs_Multistepcheckout_Customer_AddressController extends Mage_Customer_AddressController
{
    ...
    {  
        ...
        if ($this->getRequest()->isPost()) {
            ...
            $addressData['telephone']=$data['telephonecode']."-".$addressData['telephone'];
