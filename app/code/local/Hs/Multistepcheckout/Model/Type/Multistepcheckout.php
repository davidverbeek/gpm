 ...
 */
class Hs_Multistepcheckout_Model_Type_Multistepcheckout
{
    /**
            ...
            if($data['checkout_method']!='guest'){
                ...
                if($data['save_in_address_book']){
                    ...
                    $customerAddressInfo->setCustomerId($customerId)
                        ...
                        $this->getQuote()->getBillingAddress()->setCustomerAddressId($customerAddressInfo->getId())->setSaveInAddressBook('1');
    ...
    protected function _processValidateCustomer(Mage_Sales_Model_Quote_Address $address)
    {
        ...
        } else if (self::METHOD_GUEST == $this->getQuote()->getCheckoutMethod(true)) {
