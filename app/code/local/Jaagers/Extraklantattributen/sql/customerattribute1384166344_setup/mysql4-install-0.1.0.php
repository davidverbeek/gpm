...
$installer->addAttribute("customer", "betalingskortingbetalingscon",  array(
    "type"     => "varchar",
    "backend"  => "",
    ...
    "note"       => ""
        ...
        $attribute   = Mage::getSingleton("eav/config")->getAttribute("customer", "betalingskortingbetalingscon");
...
$installer->addAttribute("customer", "codebetalingscon",  array(
    "type"     => "varchar",
    "backend"  => "",
    ...
    "note"       => ""
        ...
        $attribute   = Mage::getSingleton("eav/config")->getAttribute("customer", "codebetalingscon");
...
$installer->addAttribute("customer", "percentagebetalingscon",  array(
    "type"     => "varchar",
    "backend"  => "",
    ...
    "note"       => ""
        ...
        $attribute   = Mage::getSingleton("eav/config")->getAttribute("customer", "percentagebetalingscon");
...
$installer->addAttribute("customer", "betaaltermijnbetalingscon",  array(
    "type"     => "varchar",
    "backend"  => "",
    ...
    "note"       => ""
        ...
        $attribute   = Mage::getSingleton("eav/config")->getAttribute("customer", "betaaltermijnbetalingscon");
...
$installer->addAttribute("customer", "kredietbeperkingbetalingscon",  array(
    "type"     => "varchar",
    "backend"  => "",
    ...
    "note"       => ""
        ...
        $attribute   = Mage::getSingleton("eav/config")->getAttribute("customer", "kredietbeperkingbetalingscon");
