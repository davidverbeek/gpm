...
class Techtwo_ImportExport_Model_Convert_Adapter_ProductAttributesimport
	...
	*/
	...
	public function saveRow( array $importData )
	{
			/* @var $installer Mage_Customer_Model_Entity_Setup */
			 //print_r($importData);
			 // Select * from `eav_attribute_set` Where `attribute_set_name`="" and entity_type_id =''
			 // Select * from `eav_attribute_set` Where `attribute_set_name`="" and entity_type_id ='10'
			 // eav_attribute  aka 10
			 ...
			 // die("Select * from `".$prefix."eav_attribute_set` Where `attribute_set_name`=\"".$importData["attribute_set"]."\" and entity_type_id ='".$EntityTypeId."'");
			 ...
			 //throw new Exception('techtwo testing '."Select * from `".$prefix."eav_attribute_set` Where `attribute_set_name`=\"".$importData["attribute_set"]."\" and entity_type_id ='".$EntityTypeId."'");
