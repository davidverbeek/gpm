...
class AW_Kbase_ArticleController extends Mage_Core_Controller_Front_Action
{
    ...
    public function redirectHome()
    {
        ...
        $this->_redirect('', array(
                '_direct' => AW_Kbase_Helper_Url::getModuleUrlKey().'/',
    ...
    public function articleAction()
    {
        ...
        try
        {
			...
			if ($head) {
				$head->setKeywords($article->getArticleTitle().' voor de beste klantenservice');
                $head->setDescription($article->getArticleTitle());
			}
