...
// Set Body
$trigger->setBody(
'IF (OLD.qty != NEW.qty) THEN UPDATE mage_cataloginventory_stock_item AS csi SET csi.qty = NEW.qty, csi.is_in_stock = NEW.is_in_stock WHERE csi.product_id = NEW.product_id; END IF;'
);
