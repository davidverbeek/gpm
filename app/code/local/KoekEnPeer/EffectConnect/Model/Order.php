<?php
    ...
    class KoekEnPeer_EffectConnect_Model_Order extends Mage_Core_Model_Abstract
    {
        ...
        protected function _loadOrder($fieldType, $fieldValue)
        {
			...
			/** SEND EMAILS FOR MANUAL PRODUCTS IMPORTING FROM EFFECTCONNECT PLATEFORM 	*/
			...
			foreach ($orderItems as $orderItem) {
				...
				$afwijkenidealeverpakking = $orderItem->getAfwijkenidealeverpakking();
			...
			if($higerCost){
				Mage::helper('common')->sendEmailForHigherCostAtBol($order);
			}
        ...
        protected function _updateOrderInfo()
        {
            ...
            /*  To send order confirmation email with invoice attachement.
                Ovveride Model for customised email.
            */
            $this->order->sendNewOrderEmail();
        ...
        protected function _getOrderComment()
        {
            ...
            $orderComment = "Order externe bron";
            return $orderComment;
        }
