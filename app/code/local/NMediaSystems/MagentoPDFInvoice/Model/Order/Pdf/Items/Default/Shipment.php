...
class NMediaSystems_MagentoPDFInvoice_Model_Order_Pdf_Items_Default_Shipment extends NMediaSystems_MagentoPDFInvoice_Model_Order_Pdf_Items_Abstract
{
	...
	public function draw() {
		...
		if (Mage::getStoreConfig ( 'sales/identity/displaytax', $order->getStoreId() )) {
            ...
            if($prijsfactor == 1){
            	$prijsfactor = "";
            	$stuks= Mage::helper('featured')->__('per') . " " . Mage::helper('featured')->getStockUnit($prijsfactor, $unit);
