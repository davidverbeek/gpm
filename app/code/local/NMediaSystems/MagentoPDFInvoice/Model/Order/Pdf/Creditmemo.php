 ...
 */
class NMediaSystems_MagentoPDFInvoice_Model_Order_Pdf_Creditmemo extends NMediaSystems_MagentoPDFInvoice_Model_Order_Pdf_Abstract {
    ...
    public function getPdf($creditmemos = array()) {
        ...
        foreach ( $creditmemos as $creditmemo ) {
            ...
            //Add Contact info
            $this->insertContactInfo ( $page, $order, Mage::getStoreConfigFlag ( self::XML_PATH_SALES_PDF_CREDITMEMO_PUT_ORDER_ID, $order->getStoreId () ) );
            // Add customer info
            $this->insertCreditmemoCustomerInfo ( $page, $order, Mage::getStoreConfigFlag ( self::XML_PATH_SALES_PDF_CREDITMEMO_PUT_ORDER_ID, $order->getStoreId () ) );
            ...
            $page->drawText ( Mage::helper ( 'sales' )->__ ( 'Creditfactuur: ' ), 35, 651.8, 'UTF-8' );

            $page->setFillColor ( new Zend_Pdf_Color_GrayScale ( 0 ) ); //changed 0.4 to 0
            $page->drawText ( $creditmemo->getIncrementId () , 154, 651.8, 'UTF-8' );
            ...
            // payment by add
            $page->drawText ( Mage::helper ( 'sales' )->__ ( 'Paid by' )." : ".ucfirst(strtolower($paymentmethod[0]['pm_code'])), 35, 250, 'UTF-8' );
            ...
            // Add comments
            $page = $this->insertComments ( $page, $creditmemo );
            ...
            $page = $this->insertStoreInfo ( $page, $creditmemo, $creditmemo->getStoreId () );
