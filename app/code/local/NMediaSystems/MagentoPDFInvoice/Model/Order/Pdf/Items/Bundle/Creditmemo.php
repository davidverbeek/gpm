 ...
 */
class NMediaSystems_MagentoPDFInvoice_Model_Order_Pdf_Items_Bundle_Creditmemo extends NMediaSystems_MagentoPDFInvoice_Model_Order_Pdf_Items_Bundle_Abstract {
	/**
	 * Draw item line
	 *
	 */
