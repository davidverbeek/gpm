...
class Mage_Sales_Block_Order_Totals extends Mage_Core_Block_Template
{
    ...
    protected function _initTotals()
    {
        ...
        // Parth Code added.
        $this->_totals['subtotal_incl_tax'] = new Varien_Object(array(
            'code'  => 'subtotal_incl_tax',
            'field'  => 'subtotal_incl_tax',
            'strong'=> true,
            'value' => $source->getSubtotalInclTax(),
            'label' => $this->__('Subtotal Incl. Tax')
        ));
        $this->_totals['shipping_incl_tax'] = new Varien_Object(array(
            'code'  => 'shipping_incl_tax',
            'field'  => 'shipping_incl_tax',
            'strong'=> false,
            'value' => $source->getShippingInclTax(),
            'label' => $this->__('Shipping & Handling')
        ));
