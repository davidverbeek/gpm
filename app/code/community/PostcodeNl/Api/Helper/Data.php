...
class PostcodeNl_Api_Helper_Data extends Mage_Core_Helper_Abstract
{
	...
	public function lookupAddress($postcode, $houseNumber, $houseNumberAddition)
	{
		...
		{
			$customzipcode = array("street"=>'',"houseNumber" => $houseNumber,"houseNumberAddition" =>'',"postcode" => $postcode
    									,"city" => '', "municipality" => '', "province" => '', "houseNumberAdditions" => '');
    		
    		$response = array_merge($response, $customzipcode);
			return $response;
