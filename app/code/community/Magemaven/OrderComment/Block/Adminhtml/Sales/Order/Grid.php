...
class Magemaven_OrderComment_Block_Adminhtml_Sales_Order_Grid extends Mage_Adminhtml_Block_Sales_Order_Grid
{
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumnAfter('ordercomment', array(
            ...
            'index'        => 'ordercomment',
            'filter_index' => 'main_table.customer_note',
            // 'filter_index' => 'ordercomment_table.comment',
            
        ),'status');

//         SJD++ 07062018, Removed column from sales order grid on request of Peter
//        $this->addColumnAfter('extra_verzendkosten', array(
//            'header'       => Mage::helper('ordercomment')->__('Same Day Shipment'),
