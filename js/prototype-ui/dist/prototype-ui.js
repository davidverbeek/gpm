...
UI.Window.addMethods({
  ...
  create: function() {
    function createDiv(className, options) {
      //return new Element('div', Object.extend({ className: className }, options));        Techtwo
      return (new Element('div', options)).addClassName(className);                      // Techtwo
    };
...
UI.Window.addMethods({
  ...
  createWithButtons: function() {
    ...
    this.buttons.onclick = this.onButtonsClick.bind(this);
  ...
  addButton: function(buttonName, action) {
    var button = new Element("a", { className: buttonName, href: "#"})
        .addClassName(buttonName);
  ...
  onButtonsClick: function(event) {
    var element = Event.findElement(event || window.event, 'a:not(.disabled)');
