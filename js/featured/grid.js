...
varienGridMassaction.prototype = {
    ...
    getCheckPriceboxes: function(checkedIds){
        var result = [];

        this.grid.rows.each(function(row){
            var checkboxes = row.select('.input-text-price');

            checkboxes.each(function(checkbox){
              //  var checkIdArr = checkedIds.split(",");

               // if(checkIdArr.indexOf(checkbox.id) >= 0){
    ...
    getCheckedPosString: function(checkedIds){
        var result = [];

        this.getCheckPriceboxes(checkedIds).each(function(checkbox){

            var postval = checkbox.id+'-'+ checkbox.value;
    ...
    getCheckSpPriceboxes: function(checkedIds){
        var result = [];

        this.grid.rows.each(function(row){
            var checkboxes = row.select('.input-text-specialprice');
    ...
    getCheckedSPriceString: function(checkedIds){
        var result = [];

        this.getCheckSpPriceboxes(checkedIds).each(function(checkbox){
    ...
    getCheckSpfromdateboxes: function(checkedIds){
        var result = [];

        this.grid.rows.each(function(row){
            var checkboxes = row.select('.input-text-fromdate');
    ...
    getCheckedSPFromDateString: function(checkedIds){
        var result = [];

        this.getCheckSpfromdateboxes(checkedIds).each(function(checkbox){
    ...
    getCheckSptodateboxes: function(checkedIds){
        var result = [];

        this.grid.rows.each(function(row){
            var checkboxes = row.select('.input-text-todate');
    ...
    getCheckedSPToDateString: function(checkedIds){
        var result = [];

        this.getCheckSptodateboxes(checkedIds).each(function(checkbox){
    ...
    getCheckLabelboxes: function(checkedIds){
        var result = [];

        this.grid.rows.each(function(row){
            var checkboxes = row.select('.input-text-label');
    ...
    getCheckedLabelString: function(checkedIds){
        var result = [];

        this.getCheckLabelboxes(checkedIds).each(function(checkbox){
    ...
    apply: function() {
        ...
        new Insertion.Bottom(this.formHiddens, this.fieldTemplate.evaluate({name: 'pricevalues', value: this.getCheckedPosString(this.checkedString)}));
        new Insertion.Bottom(this.formHiddens, this.fieldTemplate.evaluate({name: 'specialpricevalues', value: this.getCheckedSPriceString(this.checkedString)}));
        new Insertion.Bottom(this.formHiddens, this.fieldTemplate.evaluate({name: 'specialfromdatesvalues', value: this.getCheckedSPFromDateString(this.checkedString)}));
        new Insertion.Bottom(this.formHiddens, this.fieldTemplate.evaluate({name: 'specialtodatesvalues', value: this.getCheckedSPToDateString(this.checkedString)}));
        new Insertion.Bottom(this.formHiddens, this.fieldTemplate.evaluate({name: 'labelvalues', value: this.getCheckedLabelString(this.checkedString)}));
