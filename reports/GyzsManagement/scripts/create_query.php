...
$columns = array(
 ...
 array( 'db' =>'CASE WHEN (rspm.current_revenue IS NOT NULL && rspm.previous_revenue IS NOT NULL) THEN CONCAT(rspm.current_revenue," == ",rspm.previous_revenue) ELSE CONCAT( ifnull(current_revenue,"00")," == ",ifnull(previous_revenue,"00")) END AS compare_revenue_60',  'dt' => $column_index["compare_revenue_60"]),
