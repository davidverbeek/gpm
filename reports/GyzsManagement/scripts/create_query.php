...
if(isset(($_POST['hdn_filters'])) && $_POST['hdn_filters'] != '') {
  switch($_POST['hdn_filters']) {
    ...
    case "13":
      ...
      $extra_where = "(CAST(pmd.profit_percentage_buying_price AS DECIMAL(10,".$scale.")) < 0 AND CAST(pmd.profit_percentage_selling_price AS DECIMAL(10,".$scale.")) != 0)  AND (".implode(' OR ', $debter_mbp_condition).")";
    break;
